...
public interface SubjectMapper {
    ...
    @Mapping(source = "subject.teacher.teacherCourses", target = "teacherDto.courseDtoList")
    ...
    @Mapping(source = "subjectDto.teacherDto.courseDtoList", target = "teacher.teacherCourses")
